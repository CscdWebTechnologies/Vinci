    ...
    <div className='draft__main'>
      <div className='draft__wrapper'>
        <div className='draft__header'>
          <h1 className='draft__h1'>Get started in a few minutes</h1>
          <p className='draft__p'>
            Coinbase supports a variety of the most popular digital currencies.
          </p>
        </div>

        <section className='draft__boxes'>
          <div className='arc'>
            ...
            <h2 className='arc_h2'>Create An Account</h2>
          </div>
          ...
          <div className='account'>
            ...
            <h2 className='arc_h2'>Link Your Bank Account</h2>
          </div>
          ...
          <div className='arc'>
            ...
            <h2 className='arc_h2'>Start buying & selling</h2>
          </div>
        </section>
      </div>
    </div>
